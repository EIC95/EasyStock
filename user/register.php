...
<body class="bg-gray-50 text-gray-800 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md py-10">
        <h1 class="text-3xl font-medium mb-5 text-gray-700">Créer un compte</h1>
        ...
        <form action="register.php" class="space-y-6" method="post" enctype="multipart/form-data">
            ...
            <div>
                <label for="photo" class="text-sm text-gray-600">Photo</label>
                <input type="file" name="photo" id="photo" accept="image/*"
                    class="w-full file:hidden bg-transparent border-b border-gray-300 focus:outline-none focus:border-violet-400 text-base py-1 placeholder-gray-400" 
                />
            </div>
            <button 
                type="submit"
